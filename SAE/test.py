...
class partie():
        ...
        def lancement_jeux(menu1: menu.game, J1: personnage.perso, J2: personnage.perso, J3: personnage.perso, J4: personnage.perso):
                ...
                def demande_combat(joeur, id, J1, J2, J3, J4, monstre_total):
                        pygame.draw.rect(screen, (0,0,0), pygame.Rect(100, 100, 600, 600))
                        pygame.display.flip()
                        for i in range(len(id)):
                                if id[i]==1:
                                        Image_J1_rect.x = math.ceil(150)
                                        Image_J1_rect.y = math.ceil(150)
                                        screen.blit(Image_J1,Image_J1_rect) 
                                if id[i]==2:
                                        Image_J2_rect.x = math.ceil(200)
                                        Image_J2_rect.y = math.ceil(200)
                                        screen.blit(Image_J2,Image_J2_rect) 
                                if id[i]==3:
                                        Image_J3_rect.x = math.ceil(250)
                                        Image_J3_rect.y = math.ceil(250)
                                        screen.blit(Image_J3,Image_J3_rect) 
                                if id[i]==4:
                                        Image_J4_rect.x = math.ceil(300)
                                        Image_J4_rect.y = math.ceil(300)
                                        screen.blit(Image_J4,Image_J4_rect,)
                        for y in range(len(monstre_total)):
                                for j in range(len(id)):
                                        if monstre_total[y].id_monstre==id[j]:
                                                Image_monstre = pygame.image.load(monstre_total[y].image_monstre)
                                                Image_monstre = pygame.transform.scale(Image_monstre, (25,25))
                ...
                if menu1.nombre_joeur>=1:
                        ...
                        J1.id_perso=1
                        if J1.classe=="guerrier":
                                image_j1='images/chevalier.png'
                        elif J1.classe=="mage":
                                image_j1='images/mage.png'
                        elif J1.classe=="voleur":
                                image_j1='images/assasin.png'
                        elif J1.classe=="archer":
                                image_j1='images/archer.png'
                        Image_J1 = pygame.image.load(image_j1)
                        Image_J1 = pygame.transform.scale(Image_J1, (25,25))
                        Image_J1_rect = Image_J1.get_rect()
                        Image_J1_rect.x = math.ceil(0)
                        Image_J1_rect.y = math.ceil(0)
                        Image_j1_p1 = pygame.image.load(image_j1).convert()
                        Image_j1_p1 = pygame.transform.scale(Image_j1_p1, (100, 100))
                ...
                if menu1.nombre_joeur>=2:
                        ...
                        J2.id_perso=2
                        if J2.classe=="guerrier":
                            image_j2='images/chevalier.png'
                        elif J2.classe=="mage":
                                image_j2='images/mage.png'
                        elif J2.classe=="voleur":
                                image_j2='images/assasin.png'
                        elif J2.classe=="archer":
                                image_j2='images/archer.png'

                        Image_J2 = pygame.image.load(image_j2)
                        Image_J2 = pygame.transform.scale(Image_J2, (25,25))
                        Image_J2_rect = Image_J2.get_rect()
                        Image_J2_rect.x = math.ceil(0)
                        Image_J2_rect.y = math.ceil(0)
                        Image_j2_p1 = pygame.image.load(image_j2).convert()
                        Image_j2_p1 = pygame.transform.scale(Image_j2_p1, (100, 100))
                ...
                if menu1.nombre_joeur>=3:
                        ...
                        J3.id_perso=3
                        if J3.classe=="guerrier":
                            image_j3='images/chevalier.png'
                        elif J3.classe=="mage":
                                image_j3='images/mage.png'
                        elif J3.classe=="voleur":
                                image_j3='images/assasin.png'
                        elif J3.classe=="archer":
                                image_j3='images/archer.png'
                        Image_J3 = pygame.image.load(image_j3)
                        Image_J3 = pygame.transform.scale(Image_J3, (25,25))
                        Image_J3_rect = Image_J3.get_rect()
                        Image_J3_rect.x = math.ceil(0)
                        Image_J3_rect.y = math.ceil(0)
                        Image_j3_p1 = pygame.image.load(image_j3).convert()
                        Image_j3_p1 = pygame.transform.scale(Image_j3_p1, (100, 100))
                ...
                if menu1.nombre_joeur==4:
                        ...
                        J4.id_perso=4
                        if J4.classe=="guerrier":
                            image_j4='images/chevalier.png'
                        elif J4.classe=="mage":
                                image_j4='images/mage.png'
                        elif J4.classe=="voleur":
                                image_j4='images/assasin.png'
                        elif J4.classe=="archer":
                                image_j4='images/archer.png'
                        Image_J4 = pygame.image.load(image_j4)
                        Image_J4 = pygame.transform.scale(Image_J4, (25,25))
                        Image_J4_rect = Image_J4.get_rect()
                        Image_J4_rect.x = math.ceil(0)
                        Image_J4_rect.y = math.ceil(0)
                        Image_j4_p1 = pygame.image.load(image_j4).convert()
                        Image_j4_p1 = pygame.transform.scale(Image_j4_p1, (100, 100))
                ...
                while menu1.status==True:
                        ...
                        if plateau==False:
                                ...
                                if menu1.nombre_joeur>=1:
                                        ...
                                        screen.blit(Image_j1_p1, (15, 450)) 
                                ...
                                if menu1.nombre_joeur>=2:
                                        ...
                                        screen.blit(Image_j2_p1, (400, 450)) 
                                ...
                                if menu1.nombre_joeur>=3:
                                        ...
                                        screen.blit(Image_j3_p1, (15, 650)) 
                                ...
                                if menu1.nombre_joeur==4:
                                        ...
                                        screen.blit(Image_j4_p1, (415, 650)) 
                        ...
                        if event.type == pygame.MOUSEBUTTONDOWN:
                                ...
                                if not len(id)==0:
                                        demande_combat(joeur, id, J1, J2, J3, J4, monstre_total)
                        ...
                        #affiche le joeur
                        if menu1.nombre_joeur>=1:
                                Image_J1_rect.x = math.ceil(J1.case[0])
                                Image_J1_rect.y = math.ceil(J1.case[1])
                                screen.blit(Image_J1,Image_J1_rect) 
                        if menu1.nombre_joeur>=2:
                                Image_J2_rect.x = math.ceil(J2.case[0])
                                Image_J2_rect.y = math.ceil(J2.case[1])
                                screen.blit(Image_J2,Image_J2_rect) 
                        if menu1.nombre_joeur>=3:
                                Image_J3_rect.x = math.ceil(J3.case[0])
                                Image_J3_rect.y = math.ceil(J3.case[1])
                                screen.blit(Image_J3,Image_J3_rect) 
                        if menu1.nombre_joeur==4:
                                Image_J4_rect.x = math.ceil(J4.case[0])
                                Image_J4_rect.y = math.ceil(J4.case[1])
                                screen.blit(Image_J4,Image_J4_rect,) 
